...
* The original package name 'com.nttdata.reto_config_server.reto config server' is invalid and this project uses 'com.nttdata.reto_config_server.reto.config.server' instead.
